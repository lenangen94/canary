...
icons = { "Category_ExclusiveOffers.png" },
		name = "Lunar Shop",
		rookgaard = true,
		subclasses = { "Items", "Casks", "Exercise Weapons", "Kegs", "Potions", "Runes" },
},
	...
	-- Consumables
{
		...
		name = "Lunar Shop",
		rookgaard = true,
		subclasses = { "Items", "Casks", "Exercise Weapons", "Exclusive food", "Potions", "Runes" },
},
-- Items
 {
		...
		offers = {
				{
						...
						itemtype = 33313,
						charges = 1,
						description = "Boss Teleport Cube",
						type = GameStore.OfferTypes.TYPE_STACKABLE,
				},
				{
						icons = { "Lit_Torch.png" },
						name = "Lit Torch",
				...
				},
				{
						...
						count = 1,
						itemtype = 34016,
							description = "protection manadrain +5%",
						type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
						movable = true,
				},
				{
				...
				{
						icons = { "Stabber_Of_Eliteness.png" },
		...
		offers = {
				{
						...
						itemtype = 9082,
						charges = 1,
						description = "Increase Your magic level by 5 for 1 hour",
				...
				},
				{
						...
						itemtype = 28484,
						charges = 1,
							description = "Completly fills your mana",
						type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				},
				{
				...
				},
				{
						...
						charges = 3,
						count = 3,
						description = "It heals 5000 hp instantly.",
						type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				},
				{
						...
						itemtype = 28485,
						charges = 1,
						description = "Give you full health instantly",
						type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				},
				{
				...
				},
				{
						...
						itemtype = 11587,
						charges = 1,
						description = "This nifty does something strange.",
						type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				},
		},
},
