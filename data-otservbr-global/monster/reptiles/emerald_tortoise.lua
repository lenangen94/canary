...
monster.attacks = {
	...
	{ name = "energy chain", interval = 2500, chance = 37, minDamage = -750, maxDamage = -1000, range = 3, target = true },
	...
	{ name = "emerald tortoise large ring", interval = 2500, chance = 35, minDamage = -550, maxDamage = -1000 },
	{ name = "emerald tortoise small ring", interval = 2500, chance = 20, minDamage = -550, maxDamage = -700 },
	{ name = "emerald tortoise small explosion", interval = 2800, chance = 30, minDamage = -400, maxDamage = -600 },
	{ name = "combat", interval = 2100, chance = 30, type = COMBAT_ENERGYDAMAGE, minDamage = -450, maxDamage = -750, radius = 3, effect = CONST_ME_BLUE_ENERGY_SPARK, target = false },
}
