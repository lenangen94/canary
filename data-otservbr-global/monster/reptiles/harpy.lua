...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_PHYSICALDAMAGE, minDamage = -296, maxDamage = -350, range = 2, effect = CONST_ME_BIG_SCRATCH, target = true },
	...
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_ENERGYDAMAGE, minDamage = -320, maxDamage = -420, range = 5, radius = 4, effect = CONST_ME_ENERGYHIT, target = true },
