...
monster.attacks = {
	...
	{ name = "combat", interval = 2500, chance = 35, type = COMBAT_FIREDAMAGE, minDamage = -850, maxDamage = -1250, range = 7, radius = 3, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREATTACK, target = true },
	{ name = "gorerilla large ring", interval = 2500, chance = 35, minDamage = -600, maxDamage = -1000 },
	{ name = "gorerilla small ring", interval = 2500, chance = 20, minDamage = -600, maxDamage = -1000 },
}
